...
layout (location = 1, bindless_sampler) uniform samplerCube cubemap;
layout (location = 2, bindless_sampler) uniform sampler2D cubemap_equirect;
layout (location = 3) uniform bool equirect;
