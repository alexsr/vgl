...
int main() {
    ...
    auto shi_tomasi_shader = vgl::gl::create_shader_spirv(
        GL_FRAGMENT_SHADER, vgl::shaders_path / "corner_detection/shi_tomasi.frag");
    ...
    vgl::gl::delete_shaders({
        vertex_shader, monochrome_shader, sobel_first_shader, sobel_second_shader, shi_tomasi_shader,
