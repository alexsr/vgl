...
int main() {
    ...
    auto sobel_second_shader = vgl::gl::create_shader_spirv(GL_FRAGMENT_SHADER, vgl::shaders_path / "filters/sobel_xy_angle.frag");
    auto non_max_suppression_shader = vgl::gl::create_shader_spirv(GL_FRAGMENT_SHADER, vgl::shaders_path / "edge_detection/canny_non_max_suppression.frag");
    auto double_threshold_shader = vgl::gl::create_shader_spirv(GL_FRAGMENT_SHADER, vgl::shaders_path / "edge_detection/canny_double_threshold.frag");
    ...
    vgl::gl::delete_shaders(vertex_shader, monochrome_shader, sobel_first_shader, sobel_second_shader, double_threshold_shader,
