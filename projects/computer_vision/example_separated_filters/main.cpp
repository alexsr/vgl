...
int main() {
    ...
    auto first_pass_shader_source =
        glsp::preprocess_file((vgl::file::shaders_path / "cv/filters/separated_first_pass.frag").string()).contents;
    auto second_pass_shader_source =
        glsp::preprocess_file((vgl::file::shaders_path / "cv/filters/separated_second_pass.frag").string()).contents;
