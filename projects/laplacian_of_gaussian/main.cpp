...
int main() {
    ...
    auto laplacian_shader = vgl::gl::create_shader_spirv(GL_FRAGMENT_SHADER, vgl::shaders_path / "filters/laplacian.frag");
    ...
    vgl::gl::delete_shaders(vertex_shader, gauss_x_shader, gauss_y_shader, laplacian_shader);
